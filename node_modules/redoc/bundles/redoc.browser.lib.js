...
`),pi=X.h5`
  ...
  ${K("UnderlinedHeader")};
`,ui=(0,e.createContext)(void 0),{Provider:di,Consumer:hi}=ui;function mi(t){const{spec:r,specUrl:n,options:o,onLoaded:i,children:s}=t,[a,l]=e.useState(null),[c,p]=e.useState(null);if(c)throw c;e.useEffect((()=>{!function(){return e=this,null,t=function*(){if(r||n){l(null);try{const e=yield me(r||n);l(e)}catch(e){throw p(e),e}}},new Promise(((r,n)=>{var o=e=>{try{s(t.next(e))}catch(e){n(e)}},i=e=>{try{s(t.throw(e))}catch(e){n(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(o,i);s((t=t.apply(e,null)).next())}));var e,t}()}),[r,n]);const u=e.useMemo((()=>{if(!a)return null;try{return new Dl(a,n,o)}catch(e){throw i&&i(e),e}}),[a,n,o]);return e.useEffect((()=>{u&&i&&i()}),[u,i]),s({loading:!u,store:u})}const fi=e=>H`
  ${e} {
    cursor: pointer;
    margin-left: -20px;
    padding: 0;
...
`,js=X.div`
  ...
  height: 20px;
  bottom: -20px;
`;class Cs extends e.Component{render(){const{open:t,title:r,children:n}=this.props;return e.createElement(Es,null,n,t&&e.createElement($s,null,e.createElement(Ss,null,r),e.createElement(Rs,null),e.createElement(js,null)))}}const As="undefined"!=typeof document&&document.queryCommandSupported&&document.queryCommandSupported("copy");class Ps{static isSupported(){return As}static selectElement(e){let t,r;document.body.createTextRange?(t=document.body.createTextRange(),t.moveToElementText(e),t.select()):document.createRange&&window.getSelection&&(r=window.getSelection(),t=document.createRange(),t.selectNodeContents(e),r.removeAllRanges(),r.addRange(t))}static deselect(){if(document.selection)document.selection.empty();else if(window.getSelection){const e=window.getSelection();e&&e.removeAllRanges()}}static copySelected(){let e;try{e=document.execCommand("copy")}catch(t){e=!1}return e}static copyElement(e){Ps.selectElement(e);const t=Ps.copySelected();return t&&Ps.deselect(),t}static copyCustom(e){const t=document.createElement("textarea");t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.width="2em",t.style.height="2em",t.style.padding="0",t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.style.background="transparent",t.value=e,document.body.appendChild(t),t.select();const r=Ps.copySelected();return document.body.removeChild(t),r}}class Is extends e.PureComponent{constructor(t){super(t),this.copy=()=>{const e="string"==typeof this.props.data?this.props.data:JSON.stringify(this.props.data,null,2);Ps.copyCustom(e),this.showTooltip()},this.renderCopyButton=()=>e.createElement("button",{onClick:this.copy},e.createElement(Cs,{title:Ps.isSupported()?"Copied":"Not supported in your browser",open:this.state.tooltipShown},"Copy")),this.state={tooltipShown:!1}}render(){return this.props.children({renderCopyButton:this.renderCopyButton})}showTooltip(){this.setState({tooltipShown:!0}),setTimeout((()=>{this.setState({tooltipShown:!1})}),1500)}}let Ts=1;function _s(e,t){Ts=1;let r="";return r+='<div class="redoc-json">',r+="<code>",r+=Ns(e,t),r+="</code>",r+="</div>",r}function Ls(e){return void 0!==e?e.toString().replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function Ds(e){return JSON.stringify(e).slice(1,-1)}function zs(e,t){return'<span class="'+t+'">'+Ls(e)+"</span>"}function Ms(e){return'<span class="token punctuation">'+e+"</span>"}function Ns(e,t){const r=typeof e;let n="";return null==e?n+=zs("null","token keyword"):e&&e.constructor===Array?(Ts++,n+=function(e,t){const r=Ts>t?"collapsed":"";let n=`<button class="collapser" aria-label="${Ts>t+1?"expand":"collapse"}"></button>${Ms("[")}<span class="ellipsis"></span><ul class="array collapsible">`,o=!1;const i=e.length;for(let s=0;s<i;s++)o=!0,n+='<li><div class="hoverable '+r+'">',n+=Ns(e[s],t),s<i-1&&(n+=","),n+="</div></li>";return n+=`</ul>${Ms("]")}`,o||(n=Ms("[ ]")),n}(e,t),Ts--):e&&e.constructor===Date?n+=zs('"'+e.toISOString()+'"',"token string"):"object"===r?(Ts++,n+=function(e,t){const r=Ts>t?"collapsed":"",n=Object.keys(e),o=n.length;let i=`<button class="collapser" aria-label="${Ts>t+1?"expand":"collapse"}"></button>${Ms("{")}<span class="ellipsis"></span><ul class="obj collapsible">`,s=!1;for(let a=0;a<o;a++){const l=n[a];s=!0,i+='<li><div class="hoverable '+r+'">',i+='<span class="property token string">"'+Ls(l)+'"</span>: ',i+=Ns(e[l],t),a<o-1&&(i+=Ms(",")),i+="</div></li>"}return i+=`</ul>${Ms("}")}`,s||(i=Ms("{ }")),i}(e,t),Ts--):"number"===r?n+=zs(e,"token number"):"string"===r?/^(http|https):\/\/[^\s]+$/.test(e)?n+=zs('"',"token string")+'<a href="'+encodeURI(e)+'">'+Ls(Ds(e))+"</a>"+zs('"',"token string"):n+=zs('"'+Ds(e)+'"',"token string"):"boolean"===r&&(n+=zs(e,"token boolean")),n}const qs=H`
...
`,ga=X.button`
  ...
  font-size: 12px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;const ya=X.div`
  ${ms};
  ${({compact:e})=>e?"":"margin: 1em 0"}
`;let ba=class extends e.Component{render(){const{externalDocs:t}=this.props;return t&&t.url?e.createElement(ya,{compact:this.props.compact},e.createElement("a",{href:t.url},t.description||t.url)):null}};ba=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ra.observer],ba);class xa extends e.PureComponent{constructor(){super(...arguments),this.state={collapsed:!0}}toggle(){this.setState({collapsed:!this.state.collapsed})}render(){const{values:t,isArrayType:r}=this.props,{collapsed:n}=this.state,{enumSkipQuotes:o,maxDisplayedEnumValues:i}=this.context;if(!t.length)return null;const s=this.state.collapsed&&i?t.slice(0,i):t,a=!!i&&t.length>i,l=i?n?`… ${t.length-i} more`:"Hide":"";return e.createElement("div",null,e.createElement(oa,null,r?P("enumArray"):""," ",1===t.length?P("enumSingleValue"):P("enum"),":")," ",s.map(((t,r)=>{const n=o?String(t):JSON.stringify(t);return e.createElement(e.Fragment,{key:r},e.createElement(ha,null,n)," ")})),a?e.createElement(va,{onClick:()=>{this.toggle()}},l):null)}}xa.contextType=ae;const va=X.span`
  color: ${e=>e.theme.colors.primary.main};
  vertical-align: middle;
  font-size: 13px;
  line-height: 20px;
...
`,gc=X.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class yc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Ps.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const bc=X.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,xc=X.span`
...
`,Au=X.div`
  padding: 5px 0;
`,Pu=X.input.attrs((()=>({className:"search-input"})))`
...
`,_u=X.i`
  ...
  font-style: normal;
  color: '#666';
`;var Lu=Object.defineProperty,Du=Object.getOwnPropertyDescriptor;class zu extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.map((e=>({item:this.props.getItemById(e.meta),score:e.score})));return r.sort(((e,t)=>t.score-e.score)),e.createElement(Au,{role:"search"},this.state.term&&e.createElement(_u,{onClick:this.clear},"×"),e.createElement(Iu,null),e.createElement(Pu,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(ts,{options:{wheelPropagation:!1}},e.createElement(Tu,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(pu,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(Tu,{"data-role":"search:results"},P("noResultsFound")):null)}}zu.contextType=ae,((e,t,r,n)=>{for(var o,i=Du(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&Lu(t,r,i)})([ge.bind,(0,ge.debounce)(400)],zu.prototype,"searchCallback");class Mu extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(Z,{theme:n.theme},e.createElement(di,{value:s},e.createElement(le,{value:n},e.createElement(Ru,{className:"redoc-wrap"},e.createElement(Su,{menu:r,className:"menu-content"},e.createElement(Hl,{info:t.info}),!n.disableSearch&&e.createElement(zu,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(bu,{menu:r})),e.createElement(ju,{className:"api-content"},e.createElement(Ql,{store:s}),e.createElement(Xp,{items:r.items})),e.createElement(Cu,null)))))}}Mu.propTypes={store:se.instanceOf(Dl).isRequired};const Nu=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=F(i.hideLoading,!1),l=new Q(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(te,null,e.createElement(mi,{spec:n,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ie,{color:l.theme.colors.primary.main}):e.createElement(Mu,{store:r}))))}}(),n}()}));
